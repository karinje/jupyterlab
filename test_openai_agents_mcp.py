...
async def test_mcp_snowflake():
    ...
    mcp_config = {
        ...
        "env": {
            ...
            "SNOWFLAKE_ACCOUNT": os.environ.get("SNOWFLAKE_ACCOUNT", "NPOVSJB-PNB00757"),
            "SNOWFLAKE_DATABASE": os.environ.get("SNOWFLAKE_DATABASE", "SNOWFLAKE_LEARNING_DB"),
            "SNOWFLAKE_WAREHOUSE": os.environ.get("SNOWFLAKE_WAREHOUSE", "SNOWFLAKE_LEARNING_WH"),
    ...
    try:
        ...
        response = await asyncio.wait_for(
            Runner.run(agent, "What tables are available in Snowflake? Just list them."),
            timeout=60.0
        )
